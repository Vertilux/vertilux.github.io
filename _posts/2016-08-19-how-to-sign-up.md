...
### Step 1
The easy way to sing up into our application is by make a click on the little cog at the top right of the page:  
...
### Step 2
Then you'll see a menu with many options, just click Log In:   
...
### Step 3
If yo have an account then you can log in to your account with with email and password if not you will need to create an account bu clicking on the Sing Up link
